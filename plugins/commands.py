...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 ᴍᴏᴠɪᴇs 💠', url='https://t.me/+N8PS75om8Zw5ZjE1')
            ],[      
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    caption=f_caption,
                    reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("⚡ ᴊᴏɪɴ ɢʀᴏᴜᴘ ⚡", url="https://t.me/+N8PS75om8Zw5ZjE1") ] ] ),
    ...
    await client.send_cached_media(
        ...
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton("⚡ᴊᴏɪɴ ɢʀᴏᴜᴘ⚡", url="https://t.me/+N8PS75om8Zw5ZjE1"),
                                               InlineKeyboardButton("💥ꜱʜᴀʀᴇ💥", url="https://t.me/share/url?url=https://t.me/+N8PS75om8Zw5ZjE1") ],
